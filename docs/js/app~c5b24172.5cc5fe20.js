 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var N,A,P=(w={},w["no-ga-id"]='"'+l+'" field is empty in Firebase config. Firebase Analytics requires this field to contain a valid measurement ID.',w["already-exists"]="A Firebase Analytics instance with the measurement ID ${id}  already exists. Only one Firebase Analytics instance can be created for each measurement ID.",w["already-initialized"]="Firebase Analytics has already been initialized.settings() must be called before initializing any Analytics instanceor it will have no effect.",w["interop-component-reg-failed"]="Firebase Analytics Interop Component failed to instantiate",w),j=new s["ErrorFactory"]("analytics","Analytics",P),R={},D="dataLayer",F="gtag",G=!1;function L(e){if(G)throw j.create("already-initialized");e.dataLayerName&&(D=e.dataLayerName),e.gtagName&&(F=e.gtagName)}function U(e,t){var n=e.options[l];if(!n)throw j.create("no-ga-id");if(null!=R[n])throw j.create("already-exists",{id:n});if(!G){C()||O(D),I(D);var r=S(R,D,F),o=r.wrappedGtag,i=r.gtagCore;A=o,N=i,G=!0}R[n]=h(e,t,N);var a={app:e,logEvent:function(e,t,r){return y(A,n,e,t,r)},setCurrentScreen:function(e,t){return g(A,n,e,t)},setUserId:function(e,t){return m(A,n,e,t)},setUserProperties:function(e,t){return _(A,n,e,t)},setAnalyticsCollectionEnabled:function(e){return v(n,e)}};return a}var V="@firebase/analytics",k="0.3.8",M="analytics";function x(e){function t(e){try{var t=e.getProvider(M).getImmediate();return{logEvent:t.logEvent}}catch(n){throw j.create("interop-component-reg-failed",{reason:n})}}e.INTERNAL.registerComponent(new f["Component"](M,(function(e){var t=e.getProvider("app").getImmediate(),n=e.getProvider("installations").getImmediate();return U(t,n)}),"PUBLIC").setServiceProps({settings:L,EventName:o})),e.INTERNAL.registerComponent(new f["Component"]("analytics-internal",t,"PRIVATE")),e.registerVersion(V,k)}x(a.a)}}]);
//# sourceMappingURL=app~c5b24172.5cc5fe20.js.map